...
def get_keywords():
    df = pd.read_csv('./keywords/keywords.txt', header=None, names=['keywords'])
    ...
    for mycol in mycols:
        ...
        for tweet in tweets:
            ...
            if score > 0:
                ...
                tweets_file = open('/data1/keyword-based/%s/%s.csv' % (tweet['created_at'][4:7], tweet['created_at'][4:10]), 'a', newline='')
